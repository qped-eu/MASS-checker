...
//        parentClassInfo.setFieldKeywordConfigs(fieldKeywords);
//
...
//        }
//
//        ClassFeedback fb1 = ClassFeedbackGenerator.generateFeedback("class ChildClass", "num", HIDDEN_FIELD);
//        ClassFeedback fb2 = ClassFeedbackGenerator.generateFeedback("class ChildClass", "num1", HIDDEN_FIELD);
//
...
//        ClassInfo parentClassInfo = new ClassInfo();
//        parentClassInfo.setClassKeywords(parentClassName);
//        parentClassInfo.setMethodKeywordConfigs(methodKeywords);
//
//        String childClassName = "class ChildClass";
//        ClassInfo childClassInfo = new ClassInfo();
//        ArrayList<String> inheritsFrom = new ArrayList<>();
...
//        }
//
//        ClassFeedback fb1 = ClassFeedbackGenerator.generateFeedback("class ChildClass", "add()", HIDDEN_METHOD);
//
//        List<ClassFeedback> expectedFeedback = new ArrayList<>();
//        expectedFeedback.add(fb1);
//
...
//        }
//
//        ClassFeedback fb1 = ClassFeedbackGenerator.generateFeedback("class ChildClass", "add()", OVERWRITTEN_METHOD);
//
//        List<ClassFeedback> expectedFeedback = new ArrayList<>();
//        expectedFeedback.add(fb1);
//
...
//
//    @Test
//    public void accessTooRestrictive() {
...
//        }
//
//        ClassFeedback fb1 = ClassFeedbackGenerator.generateFeedback("class TestClass", "", CLASS_ACCESS_TOO_RESTRICTIVE);
//
//        List<ClassFeedback> expectedFeedback = new ArrayList<>();
//        expectedFeedback.add(fb1);
//
...
//
//    @Test
//    public void accessNotRestrictiveEnough() {
...
//        }
//
//        ClassFeedback fb1 = ClassFeedbackGenerator.generateFeedback("class TestClass", "", CLASS_ACCESS_NOT_RESTRICTIVE_ENOUGH);
//
//        List<ClassFeedback> expectedFeedback = new ArrayList<>();
//        expectedFeedback.add(fb1);
//
...
//        }
//
//        ClassFeedback fb1 = ClassFeedbackGenerator.generateFeedback("class TestClass", "", WRONG_CLASS_NON_ACCESS_MODIFIER);
//
//        List<ClassFeedback> expectedFeedback = new ArrayList<>();
//        expectedFeedback.add(fb1);
//
...
//        }
//
//        ClassFeedback fb1 = ClassFeedbackGenerator.generateFeedback("class TestClass", "", WRONG_CLASS_TYPE);
//
//        List<ClassFeedback> expectedFeedback = new ArrayList<>();
//        expectedFeedback.add(fb1);
//
...
//        }
//
//        ClassFeedback fb1 = ClassFeedbackGenerator.generateFeedback("class TestClass", "", WRONG_CLASS_NAME);
//        ClassFeedback fb2 = ClassFeedbackGenerator.generateFeedback("class TestClass", "Number", MISSING_INTERFACE_IMPLEMENTATION);
//        List<ClassFeedback> expectedFeedback = new ArrayList<>();
//        expectedFeedback.add(fb1);
//        expectedFeedback.add(fb2);
//
...
//        }
//
//        ClassFeedback fb1 = ClassFeedbackGenerator.generateFeedback("interface TestClass", "", WRONG_CLASS_TYPE);
//        List<ClassFeedback> expectedFeedback = new ArrayList<>();
//        expectedFeedback.add(fb1);
//
//        assertArrayEquals(expectedFeedback.toArray(), classChecker.getClassFeedbacks().toArray());
...
//        }
//
//        ClassFeedback fb1 = ClassFeedbackGenerator.generateFeedback("class TestClass", "Number",
