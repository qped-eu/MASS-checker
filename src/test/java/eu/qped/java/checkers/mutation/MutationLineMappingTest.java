...
class MutationLineMappingTest {
    ...
    void testCase1() throws IOException {
        genericTest(1, "case1", false);
    }

    @Test
    void testCase2() throws IOException {
        genericTest(1, "case2", false);
    }

    @Test
    void testCase3() throws IOException {
        genericTest(1, "case3", false);
    }

    @Test
    void testCase4() throws IOException {
        genericTest(1, "case4", false);
    }

    @Test
    void testCase5() throws IOException {
        genericTest(1, "case5", false);
    }

    @Test
    void testCaseAllStudentTests() throws IOException {
        for (int i = 1; i <= 6; i++) {
            genericTest(i, "case6", false);
        }
    }

    @Test
    void testCase7() throws IOException {
        genericTest(1, "case7", false);
    }

    public void genericTest(int count, String caseName, boolean startsWithInsteadOfEquals) throws IOException, JsonProcessingException, JsonMappingException {
        ...
        String answer = FileUtils.readFileToString(new File(baseDirectory, "answer" + count + ".java"), Charset.defaultCharset());
        ...
        String expected = FileUtils.readFileToString(new File(baseDirectory, "expected" + count + ".txt"), Charset.defaultCharset())
