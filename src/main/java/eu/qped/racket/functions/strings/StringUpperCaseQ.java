...
public class StringUpperCaseQ extends Expression {
    ...
    /**
     * Checks if a String expression is equal to its uppercase version.
     *
     * @param list List of expressions containing a single String argument
     * @return True if the String expression is equal to its uppercase version, false otherwise
    ...
    public Object evaluate(List<Expression> list) throws Exception {
        ...
        try {
            return ((String) list.get(0).evaluate(this)).equals(((String) list.get(0).evaluate(this)).toUpperCase());
    ...
    public String toString() {
        return "StringUppercaseQ" + "(" + super.getId() + ")";
    }
}
