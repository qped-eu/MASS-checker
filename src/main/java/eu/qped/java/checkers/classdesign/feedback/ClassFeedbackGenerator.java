...
//    //Element Feedback
//    public final static String WRONG_ELEMENT_NAME = "ElementNameError";
//    public final static String WRONG_ELEMENT_TYPE = "ElementTypeError";
//
//    //Modifier Feedback
...
//    public final static String DIFFERENT_CLASS_NAMES_EXPECTED = "DifferentClassNamesExpected";
    ...
    private static Map<String, String> createFeedbackMap() {
        ...
        feedbackMap.put(WRONG_ELEMENT_TYPE.toString(),
        ...
        feedbackMap.put(WRONG_ELEMENT_NAME.toString(),
        ...
        feedbackMap.put(WRONG_ACCESS_MODIFIER.toString(),
        ...
        feedbackMap.put(WRONG_NON_ACCESS_MODIFIER.toString(),
        ...
        feedbackMap.put(WRONG_CLASS_ACCESS_MODIFIER.toString(),
        ...
        feedbackMap.put(WRONG_CLASS_NON_ACCESS_MODIFIER.toString(),
        ...
        feedbackMap.put(HIDDEN_METHOD.toString(),
        ...
        feedbackMap.put(MISSING_INTERFACE_IMPLEMENTATION.toString(),
        ...
        feedbackMap.put(MISSING_ABSTRACT_CLASS_EXTENSION.toString(),
        ...
        feedbackMap.put(MISSING_STATIC_CLASS_EXTENSION.toString(),
        ...
        feedbackMap.put(WRONG_SUPER_CLASS_NAME.toString(),
        ...
        feedbackMap.put(DIFFERENT_INTERFACE_NAMES_EXPECTED.toString(),
        ...
        feedbackMap.put(DIFFERENT_CLASS_NAMES_EXPECTED.toString(),
