...
import eu.qped.umr.exceptions.LanguageNotSupportedException;
...
public class Translator {
    ...
    public String translate(String langFrom, String langTo, String text) throws IOException, LanguageNotSupportedException {
        String result = "";
        try {
            // INSERT YOU URL HERE
            ...
            if (con.getResponseCode() == -1){
                throw new LanguageNotSupportedException("request failed");
            }
